...
puts "Comenzando middleware..."
  ...
  puts "Iniciando SpreeManager... "	
	#sm= Products.new
	puts "Iniciando SpreeManager... OK"
...
for i in 0.. ofertas.size-1
 ...
 if(Time.at(ofertas[i][2].to_i/1000)<=Time.now)
 	#ACA HAY QUE INSERTAR EL PRECIO EN EL SPREE !!! LA VARIABLE DONDE ESTA EL PRECIO ES ofertas[i][1].to_s
 #	sm.setPrice(ofertas[i][0], ofertas[i][1].to_i)
