...
class Pricing
	def initialize()
		...
		@CostoTraspaso=[]
		@CostoAlmacenajeExt=[]	
		@path="C:/Users/Felipe/Dropbox/Documentos Taller S2 2013/temp/Pricing.csv"
	...
	def getCostoAlmacenExt(temp_SKU)
		if @SKU.include? temp_SKU.to_i
